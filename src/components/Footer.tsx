...
export function Footer() {
  return (
    <section className="w-full bg-zinc-900 py-12 dark:bg-zinc-100 md:py-24 lg:py-32">
      <div className="container flex flex-col items-center px-4 text-center md:px-6">
        ...
        <div className="flex justify-center space-x-4">
          <Link aria-label="Facebook page" className="text-white" to="#">
            <FacebookIcon />
          </Link>
          <Link aria-label="Twitter profile" className="text-white" to="#">
            <TwitterIcon />
          </Link>
          <Link aria-label="Instagram profile" className="text-white" to="#">
            <InstagramIcon />
          </Link>
          <Link aria-label="LinkedIn profile" className="text-white" to="#">
            <LinkedinIcon />
          </Link>
        </div>
      </div>
